let docker_compose_args = get(g:, 'docker_compose_files', '')
" General {{{
...
if exists('g:javascript_eslint_docker') && g:javascript_eslint_docker == 1
  ...
  let eslint_command = 'silent !docker-compose ' . docker_compose_args . ' exec -T ' . service . ' ./node_modules/eslint/bin/eslint.js --fix %'
...
if exists('g:javascript_js_beautify_docker') && g:javascript_js_beautify_docker == 1
  ...
  let js_beautify_command = 'silent !docker-compose ' . docker_compose_args . ' exec -T ' . service . ' ./node_modules/eslint/bin/js-beautify -r -q -B %'
