...
if exists('g:javascript_eslint_docker') && g:javascript_eslint_docker == 1
  ...
  let eslint_command = 'silent !' . docker_compose_command . ' exec -T ' . service . ' ./node_modules/eslint/bin/eslint.js --fix %'
...
if exists('g:javascript_js_beautify_docker') && g:javascript_js_beautify_docker == 1
  ...
  let js_beautify_command = 'silent !' . docker_compose_command . ' exec -T ' . service . ' ./node_modules/eslint/bin/js-beautify -r -q -B %'
...
if exists('g:javascript_eslint_docker') && g:javascript_eslint_docker == 1
  ...
  let g:neomake_javascript_eslint_exe = docker_compose_command
  let g:neomake_javascript_eslint_args = ['exec', '-T', service, './node_modules/eslint/bin/eslint.js', '--stdin', '%'] + neomake#makers#ft#javascript#eslint().args
